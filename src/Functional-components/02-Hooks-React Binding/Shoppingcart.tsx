                    ...
                    <div className="row">
                        <div className="col">
                            <table className='table table-hover table-striped'>
                                ...
                                <tbody>
                                    <tr>
                                        <td>{shoppingState.Product.sno}</td>
                                        <td>{
                                            <img src={shoppingState.Product.image}
                                            width="70" height="70"
                                             alt=""
                                               />
                                            }</td>

                                        <td>{shoppingState.Product.name}</td>
                                        <td>{shoppingState.Product.price}</td>
                                        <td>{shoppingState.Product.qty}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
