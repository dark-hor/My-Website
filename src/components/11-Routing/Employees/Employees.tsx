...
interface IProps {
    sendContact: (contact: IEmployee) => void;
};
interface IState {
    contacts: IEmployee[];
};
class Employees extends React.Component<IProps, IState> {
    ...
    selectedContact = (contact: IEmployee) => {
                                    ...
                                    contacts.map(contact => {
                                        return (
                                            <tr key={contact.login.uuid}>
                                                ...
                                                <td> <NavLink to={`/employees/${contact.login.uuid}`} className="text-primary">
                                                    {contact.name.title}
                                                    {contact.name.first}
                                                    {contact.name.last}
                                                </NavLink></td>
